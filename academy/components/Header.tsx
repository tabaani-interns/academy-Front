    ...
    <header className="bg-white shadow-sm border-b border-gray-200">
            ...
            <div className="flex items-center space-x-3">
              <div className="flex items-center space-x-2">
                ...
                <div className="hidden sm:block">
                  <p className="text-sm font-medium text-gray-700">Hamza,</p>
      ...
      <div className="md:hidden">
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
          <button className="flex items-center text-gray-700 hover:text-gray-900 block px-3 py-2 text-base font-medium w-full text-left">
            Categories
            <ChevronDown className="ml-1 h-4 w-4" />
          </button>
          <button className="text-gray-700 hover:text-gray-900 block px-3 py-2 text-base font-medium">
            Partner
          </button>
          <button className="text-gray-700 hover:text-gray-900 block px-3 py-2 text-base font-medium">
            Contact Us
